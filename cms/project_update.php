...
<body>
    ...
    <form action="update_project.php" method="post" style="margin-left : auto;margin-top: auto; margin-right: auto; margin-bottom: auto;">
        ...
        <label>Project Name</label>
            <?php if (isset($_GET['projectName'])) { ?>
                <input type="text" 
                      name="projectName" 
                      value="<?php echo $_GET['projectName']; ?>"><br>
            <?php }else{ ?>
                <input type="text" 
                    name="projectName" ><br>
            <?php }?>
